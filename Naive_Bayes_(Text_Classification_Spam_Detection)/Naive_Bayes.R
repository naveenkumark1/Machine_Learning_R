...
getwd()
setwd("C:/Users/BestintownACER1/Desktop/ML_R/Del_Naive_Bayes")
...
as.character(smsDataCorpus[[3]])

as.character(smsData_corpus_clean[[3]])
...
sms_classifier  # Full ist of tables 
